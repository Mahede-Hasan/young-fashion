                    ...
                    <form>
                        <div class="flex">
                            ...
                            <div class="relative w-full">
                                <input type="search" class="input-box block py-2 lg:pr-60 lg:pl-12 md:pr-44 w-full text-sm text-gray-900 bg-gray-200 focus:ring-0 focus:border-none border-none border  focus:outline-none" placeholder="Search your product" required="" />
